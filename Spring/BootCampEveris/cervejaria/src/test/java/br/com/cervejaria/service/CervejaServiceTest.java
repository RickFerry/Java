...
public class CervejaServiceTest {
	...
	void whenValidBeerNameIsGivenThenReturnABeer() throws CervejaNotFoundException {
		...
		// then
		CervejaDTO foundBeerDTO = beerService.findByName(expectedFoundBeerDTO.getNome());
	...
	void whenNotRegisteredBeerNameIsGivenThenThrowAnException() {
		...
		// then
		assertThrows(CervejaNotFoundException.class, () -> beerService.findByName(expectedFoundBeerDTO.getNome()));
	}
